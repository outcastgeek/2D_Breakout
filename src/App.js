...
class App extends Component {
    ...
    /* This will get compiled correctly for now */
    ...
    _canvas = undefined
    _context = undefined
    _player = new Player(this, this.state, App.propTypes, this._keystate)
    _ai = new AI(this, this.state, App.propTypes)
    _ball = new Ball(this, this.state, App.propTypes, this._ai, this._player)
    _loop = undefined
    _canvasStyle = {
        display: 'block',
        position: 'absolute',
...
export default App // Just export the class after creating it
